...
func (n *Node) startRPC(services map[reflect.Type]Service) error {
	...
	if err := n.startHTTP(n.httpEndpoint, apis, n.config.HTTPModules, []string{"*"}, []string{"*"}, n.config.HTTPTimeouts); err != nil {
		n.stopIPC()
		n.stopInProc()
		return err
	}
	if err := n.startWS(n.wsEndpoint, apis, n.config.WSModules, []string{"*"}, n.config.WSExposeAll); err != nil {
		n.stopHTTP()
		n.stopIPC()
		n.stopInProc()
		return err
